...
class Detailinfor extends React.Component {
  ...
  BackDetail(em){
    ...
    this.props.onBackSubmit(showDetail);
  }
  handleSubmit(e) {
    e.preventDefault();
      ...
      <Form  className='content' horizontal onSubmit={this.handleSubmit.bind(this)}>
        ...
        <div className='Modal-Bx'>
          ...
          <div className='Content-Bx'>
            ...
            <FormItem
              ...
              wrapperCol={{ span: 8 }}
              help="请上传正确附件">
              <Upload name="logo" className='upload'  listType="picture" onChange={this.handleUpload}
        ...
        <Row>
          <div className='button-bx'>
            ...
            <div>
              <Button htmlType="" onClick={this.BackDetail.bind(this)}>返回</Button>
            </div>
            <div className='clear'></div>
          </div>
        </Row>
...
Detailinfor = Form.create()(Detailinfor);
